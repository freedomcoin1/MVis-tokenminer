...
function init() {
    ...
    if(process.argv.length > 2) {
        ...
        drawLayout();
        console.log('Welcome to FreeDom: The Begining of freedom in crypto')
        console.log('Built by the Undead ')
        console.log('')
...
async function handleCommand(result) {
    ...
    if (subsystem_name == 'test' && subsystem_command == 'mine') {
        ...
        var ropsten_contract_address = ContractInterface.networks.testnet.contracts._FreeDom.blockchain_address
